...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>About - Joshua Stebler</title>
        <meta property="og:title" content="About - Joshua Stebler" />
      </Helmet>
      <header data-role="Header" className="about-header">
        <Link to="/" className="about-navlink">
          <img
            alt="logo"
            src="/playground_assets/img_0152-1500h.jpg"
        ...
        <div data-role="MobileMenu" className="about-mobile-menu">
          <div className="about-nav1">
            <div className="about-container1">
              ...
              />
              <div data-role="CloseMobileMenu" className="about-menu-close">
      ...
      <div className="about-stats">
        <div className="about-stat">
          <h1 className="about-text">20</h1>
          <span className="about-text01">Jahre alt</span>
          <span className="about-text02">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className="about-stat1">
          <h1 className="about-text03">20&apos;000+</h1>
          <span className="about-text04">Fotos gemacht</span>
          <span className="about-text05">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className="about-stat2">
          <h1 className="about-text06">
            <span>500</span>
            <span>+</span>
          </h1>
          <span className="about-text09">Hours</span>
          <span className="about-text10">
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className="about-stat3">
          <h1 className="about-text11">24/7</h1>
          <span className="about-text12">am atmen</span>
